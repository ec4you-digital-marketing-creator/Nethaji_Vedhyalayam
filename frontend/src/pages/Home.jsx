      ...
      <section className="relative h-[600px] md:h-[700px] lg:h-[800px] flex items-center justify-center bg-brand-navy overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          <video
            ...
            playsInline
            preload="metadata"
            poster={getImageUrl(heroVideo?.thumbnail) || eventFallbackImage}
            className="w-full h-full object-cover"
          >
            <source
              src={heroVideo?.video_file
                ? getImageUrl(heroVideo.video_file)
              ...
              <div className="grid grid-cols-12 gap-4 h-[400px] md:h-[500px] lg:h-[650px] relative">
                ...
                <div className="col-span-12 md:col-span-7 h-full relative group">
                  <div className="h-full rounded-3xl overflow-hidden shadow-2xl">
                    <img
                      src={getImageUrl(homeAbout?.image1) || aboutImage1}
                      alt="School Campus"
                      width="800"
                      height="600"
                      loading="lazy"
                ...
                <div className="hidden md:flex md:col-span-5 flex-col gap-4">
                  <div className="h-1/2 relative group">
                    <div className="h-full rounded-3xl overflow-hidden shadow-xl">
                      <img
                        src={getImageUrl(homeAbout?.image2) || aboutImage2}
                        alt="Classroom"
                        width="400"
                        height="300"
                        loading="lazy"
                  ...
                  <div className="h-1/2 relative group">
                    <div className="h-full rounded-3xl overflow-hidden shadow-xl">
                      <img
                        src={getImageUrl(homeAbout?.image3) || aboutImage3}
                        alt="Laboratory"
                        width="400"
                        height="300"
                        loading="lazy"
            ...
            {(teamMembers.length > 0 ? teamMembers : [
              ...
              <div key={index} className="relative group mt-12">
                ...
                <div className="absolute -top-16 left-1/2 -translate-x-1/2 w-32 h-32 rounded-full overflow-hidden border-4 border-white/20 group-hover:border-primary transition-colors shadow-lg z-20">
                  <img
                    src={getImageUrl(leader.photo) || "https://via.placeholder.com/150"}
                    alt={leader.name}
                    width="128"
                    height="128"
                    loading="lazy"
              ...
              {getVisibleCards().map((event, index) => (
                ...
                >
                  <div className="relative h-48 overflow-hidden">
                    <img
                      src={getImageUrl(event.image) || eventFallbackImage}
                      alt={event.title}
                      loading="lazy"
                      decoding="async"
